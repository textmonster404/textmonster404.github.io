		...
		*/
		M.plants={
			...
			'elderwort':{
				...
				{
					if (age>=this.mature) M.dropUpgrade('Elderwort biscuits',0.1);
				},
			},
			'bakeberry':{
				name:'Bakeberry',
				...
				onHarvest:function(x,y,age)
				{
					if (age>=this.mature)
					{
						...
						M.dropUpgrade('Bakeberry cookies',0.15);
					}
				},
			},
			'chocoroot':{
			...
			'drowsyfern':{
				...
				onHarvest:function(x,y,age)
				{
					if (age>=this.mature) M.dropUpgrade('Fern tea',0.1);
				},
			},
			'wardlichen':{
				name:'Wardlichen',
			...
			'duketater':{
				...
				onHarvest:function(x,y,age)
				{
					if (age>=this.mature)
					{
						...
						M.dropUpgrade('Duketater cookies',0.05);
					}
				},
			},
			'crumbspore':{
			...
			'greenRot':{
				...
				onHarvest:function(x,y,age)
				{
					if (age>=this.mature) M.dropUpgrade('Green yeast digestives',0.05);
				},
			},
			'shriekbulb':{
				name:'Shriekbulb',
			...
			'ichorpuff':{
				...
				onHarvest:function(x,y,age)
				{
					if (age>=this.mature) M.dropUpgrade('Ichor syrup',0.05);
				},
			},
		};
		...
		M.tools={
			'info':{
				...
				descFunc:function()
				{
					...
					str+='<small style="line-height:100%;">&bull; You can cross-breed plants by planting them close to each other; new plants will grow in the empty tiles between them.<br>&bull; Unlock new seeds by harvesting mature plants.<br>&bull; When you ascend, your garden plants are reset, but you keep all the seeds you\'ve unlocked.<br>&bull; Your garden has no effect and does not grow while the game is closed.</small>';
					return str;
				},
				func:function(){},
			},
		...
		M.refillTooltip=function(){
			return '<div style="padding:8px;width:300px;font-size:11px;text-align:center;">Click to refill your soil timer and trigger <b>1</b> plant growth tick for <span class="price lump">1 sugar lump</span>.'+
